...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="optional">optional</span> Return a replacement data table, or nil to keep the modified `data`.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> Override for the stamina offset; nil keeps the existing value.</p>
...
<details class="realm-shared">
<summary><a id=CanCharBeTransfered></a>CanCharBeTransfered(tChar, faction, oldFaction)</summary>
...
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|string</a></span> <span class="parameter">oldFaction</span> Current faction or class being left.</p>
...
<details class="realm-shared">
<summary><a id=CanPlayerKnock></a>CanPlayerKnock(client, door)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="parameter">client</span> Player attempting to knock.</p>
<p><span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Entity">Entity</a></span> <span class="parameter">door</span> Door entity being knocked on.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean|string</a></span> <span class="optional">optional</span> Return false to stop the punch; optionally return a reason string.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> Maximum allowed level (defaults to infinity).</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> Maximum value allowed at creation; nil falls back to default limits.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> Max stamina value; defaults to `DefaultStamina` config when nil.</p>
...
<details class="realm-shared">
<summary><a id=GetDefaultCharDesc></a>GetDefaultCharDesc(client, faction, data)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="parameter">client</span> Player creating the character.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">faction</span> Faction index being created.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="optional">optional</span> Name to display; nil lets the default recognition logic run.</p>
...
<details class="realm-shared">
<summary><a id=GetHandsAttackSpeed></a>GetHandsAttackSpeed(client, defaultDelay)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="parameter">client</span> Player punching.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">defaultDelay</span> Default delay before the next punch.</p>

<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> Replacement delay; nil keeps the default.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="optional">optional</span> Model path to use; nil keeps the item's configured model.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> Maximum character slots; nil falls back to `MaxCharacters` config.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> Maximum points allowed; nil keeps the default.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="optional">optional</span> "female" to treat as female, or nil for default male handling.</p>
...
<details class="realm-shared">
<summary><a id=GetMoneyModel></a>GetMoneyModel(amount)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">amount</span> Amount of currency the entity holds.</p>

<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="optional">optional</span> Model path override; nil falls back to `MoneyModel` config.</p>
...
<details class="realm-shared">
<summary><a id=GetNPCDialogOptions></a>GetNPCDialogOptions(client, npc, canCustomize)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="parameter">client</span> Player interacting with the NPC.</p>
<p><span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Entity">Entity</a></span> <span class="parameter">npc</span> NPC being talked to.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> <span class="parameter">canCustomize</span> Whether the NPC supports customization options.</p>

<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="optional">optional</span> Extra dialog options keyed by unique id; nil keeps defaults only.</p>
...
<details class="realm-shared">
<summary><a id=GetPlayerPunchDamage></a>GetPlayerPunchDamage(client, damage, context)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="parameter">client</span> Punching player.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">damage</span> Default damage.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">context</span> Context table you may mutate (e.g., `context.damage`).</p>

<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> New damage value; nil uses `context.damage` or the original.</p>
...
<details class="realm-shared">
<summary><a id=GetPlayerPunchRagdollTime></a>GetPlayerPunchRagdollTime(client, target)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="parameter">client</span> Attacker.</p>
<p><span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Entity">Entity</a></span> <span class="parameter">target</span> Target player being knocked out.</p>

<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> Ragdoll duration in seconds; nil uses `PunchRagdollTime` config.</p>
...
<details class="realm-shared">
<summary><a id=GetPriceOverride></a>GetPriceOverride(client, vendor, uniqueID, price, isSellingToVendor)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="parameter">client</span> Player entity.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> Replacement price; nil keeps the existing calculation.</p>

<h3>Example Usage:</h3>
<pre><code class="language-lua">    hook.Add("GetPriceOverride", "FactionDiscount", function(client, vendor, uniqueID, price, isSellingToVendor)
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> Replacement time; nil keeps the proposed duration.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> Multiplier applied to prices (e.g., 0.9 for 10% off); nil keeps vendor defaults.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="optional">optional</span> Custom weapon name; nil falls back to print name.</p>
...
<details class="realm-shared">
<summary><a id=IsCharRecognized></a>IsCharRecognized(a, id)</summary>
...
<details class="realm-shared">
<summary><a id=ItemDefaultFunctions></a>ItemDefaultFunctions(funcs)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">funcs</span> Functions table for the item being registered.</p>
...
<details class="realm-shared">
<summary><a id=OnAdminSystemLoaded></a>OnAdminSystemLoaded(adminData, metadata)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">adminData</span> <span class="optional">optional</span> Admin integration data, if provided.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">metadata</span> <span class="optional">optional</span> Additional metadata from the admin system.</p>
...
<details class="realm-shared">
<summary><a id=OnPlayerPurchaseDoor></a>OnPlayerPurchaseDoor(client, door, selling)</summary>
...
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> <span class="parameter">selling</span> True if selling/refunding, false if buying.</p>
...
<details class="realm-shared">
<summary><a id=OnPlayerRotateItem></a>OnPlayerRotateItem(client, item, newRot)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="parameter">client</span> The player who rotated the item.</p>
...
<details class="realm-shared">
<summary><a id=OnPrivilegeRegistered></a>OnPrivilegeRegistered(privilege, context1, context2, context3)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">privilege</span> CAMI privilege table or simplified privilege data.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#2.2">any</a></span> <span class="parameter">context1</span> Optional extra data from the source integration.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#2.2">any</a></span> <span class="parameter">context2</span> Optional extra data from the source integration.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#2.2">any</a></span> <span class="parameter">context3</span> Optional extra data from the source integration.</p>
...
<details class="realm-shared">
<summary><a id=OnPrivilegeUnregistered></a>OnPrivilegeUnregistered(privilege, context)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">privilege</span> Privilege data being removed.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#2.2">any</a></span> <span class="parameter">context</span> Optional extra data.</p>
...
<details class="realm-shared">
<summary><a id=OnUsergroupCreated></a>OnUsergroupCreated(groupName, data)</summary>
...
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#2.2">any</a></span> <span class="parameter">data</span> Optional extra data (e.g., privilege list).</p>
...
<details class="realm-shared">
<summary><a id=OverrideFactionDesc></a>OverrideFactionDesc(uniqueID, desc)</summary>
...
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">desc</span> Current description.</p>

<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="optional">optional</span> Replacement description; nil keeps the existing text.</p>
...
<details class="realm-shared">
<summary><a id=OverrideFactionModels></a>OverrideFactionModels(uniqueID, models)</summary>
...
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">models</span> Default models table.</p>

<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="optional">optional</span> Replacement models table; nil keeps defaults.</p>
...
<details class="realm-shared">
<summary><a id=OverrideFactionName></a>OverrideFactionName(uniqueID, name)</summary>
...
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">uniqueID</span> Faction identifier.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">name</span> Default faction name.</p>

<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="optional">optional</span> Replacement name; nil keeps the default.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> New respawn time; nil keeps the base value.</p>
