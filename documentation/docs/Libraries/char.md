...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="optional">optional</span> The character object if already cached; otherwise nil while loading.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table|any</a></span> <span class="optional">optional</span> Table of all key/value pairs, a single value when key is provided, or nil if not found/invalid.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#2.2">any|table|false</a></span> <span class="optional">optional</span> Decoded value for the key, a table of all key/value pairs, false if a keyed lookup is missing, or nil on invalid input.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="optional">optional</span> Player who currently has the character loaded, or nil if none.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="optional">optional</span> Character object if the player is online and has one loaded, else nil.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="optional">optional</span> Ban flag/value (0 if not banned), or nil on invalid input.</p>
