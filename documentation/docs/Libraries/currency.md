...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Entity">Entity</a></span> <span class="optional">optional</span> Created `lia_money` entity, or nil if input is invalid or entity creation fails.</p>
