...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="optional">optional</span> The configuration table if found, nil otherwise.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="optional">optional</span> Sanitized NPC dialog data, or nil if not found.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="optional">optional</span> Original NPC dialog data, or nil if not found.</p>
