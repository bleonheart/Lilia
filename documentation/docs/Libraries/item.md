...
<p>Registers an item with named parameters for convenience.</p>
<p>Called when creating items programmatically with named parameters instead of the standard register format.</p>
<p><h3>Parameters:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">id</span> The unique identifier for the item.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#2.2">string, optional</a></span> <span class="parameter">base</span> The base item ID to inherit from (defaults to lia.meta.item).</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">properties</span> A table of named properties to set on the item (name, desc, etc.).</p>

<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> The registered item definition table.</p>

<h3>Example Usage:</h3>
<pre><code class="language-lua">    lia.item.registerItem("custom_food", "base_food", {
        name = "Custom Apple",
        desc = "A delicious custom apple",
        price = 50,
        width = 1,
        height = 1
    })
