...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="optional">optional</span> The matching player with a loaded character, or nil if not found/invalid input.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="optional">optional</span> Matched player or nil when no match is found/identifier is invalid.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="optional">optional</span> Matching player or nil when none is found/SteamID64 is invalid.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="optional">optional</span> Player whose SteamID matches, or nil if none.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="optional">optional</span> Matching faction table, or nil if not found.</p>
...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Panel">Panel</a></span> <span class="optional">optional</span> The created frame, or nil if no valid options exist.</p>
