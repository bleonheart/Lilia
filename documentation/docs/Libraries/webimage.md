...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Material">Material</a></span> <span class="optional">optional</span> The cached material or `nil` if it isn't downloaded yet.</p>
