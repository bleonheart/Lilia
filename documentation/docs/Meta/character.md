...
<p><h3>Returns:</h3>
<span class="types"><a class="type" href="https://wiki.facepunch.com/gmod/Player">Player</a></span> <span class="optional">optional</span> Player that owns the character, or nil if not found.</p>
