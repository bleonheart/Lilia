...
<details class="realm-shared" id="function-liafactiongetcharactercreationradius">
<summary><span class="summary-main"><a id="lia.faction.getCharacterCreationRadius"></a>lia.faction.getCharacterCreationRadius(faction, class, fallback)</span><a class="source-link-button source-link-button--summary" href="https://github.com/LiliaFramework/Lilia/blob/main/gamemode/core/libraries/factions.lua#L1068" target="_blank" rel="noopener noreferrer" onclick="event.stopPropagation()">View Source</a></summary>
<div class="details-content">
<h3 style="margin-bottom: 5px; font-weight: 700;"><a id="liafactiongetcharactercreationradius"></a>Purpose</h3>
<div style="margin-left: 20px; margin-bottom: 20px;">
  <p>Resolves the effective radius for a faction/class combination, preferring class data when present.</p>
</div>
...
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#2.1">number</a></span> <span class="parameter">fallback</span> <span class="optional">optional</span> Optional fallback radius returned when neither class nor faction defines one.</p>
</div>

<h3 style="margin-bottom: 5px; font-weight: 700;">Returns</h3>
<div style="margin-left: 20px; margin-bottom: 20px;">
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#2.1">number|nil</a></span> The resolved radius, using class data first and faction data second.</p>
</div>

<h3 style="margin-bottom: 5px; font-weight: 700;">Example Usage</h3>
<div style="margin-left: 20px; margin-bottom: 20px;">
<pre><code class="language-lua">  local radius = lia.faction.getCharacterCreationRadius(FACTION_CITIZEN, CLASS_RESIDENT, 0)
</code></pre>
</div>
...
<summary><span class="summary-main"><a id="lia.faction.jobGenerate"></a>lia.faction.jobGenerate(index, name, color, default, models)</span><a class="source-link-button source-link-button--summary" href="https://github.com/LiliaFramework/Lilia/blob/main/gamemode/core/libraries/factions.lua#L1217" target="_blank" rel="noopener noreferrer" onclick="event.stopPropagation()">View Source</a></summary>
<div class="details-content">
...
<summary><span class="summary-main"><a id="lia.faction.getCategories"></a>lia.faction.getCategories(teamName)</span><a class="source-link-button source-link-button--summary" href="https://github.com/LiliaFramework/Lilia/blob/main/gamemode/core/libraries/factions.lua#L1364" target="_blank" rel="noopener noreferrer" onclick="event.stopPropagation()">View Source</a></summary>
<div class="details-content">
...
<summary><span class="summary-main"><a id="lia.faction.getDefaultClass"></a>lia.faction.getDefaultClass(id)</span><a class="source-link-button source-link-button--summary" href="https://github.com/LiliaFramework/Lilia/blob/main/gamemode/core/libraries/factions.lua#L1429" target="_blank" rel="noopener noreferrer" onclick="event.stopPropagation()">View Source</a></summary>
<div class="details-content">
...
<summary><span class="summary-main"><a id="lia.faction.hasWhitelist"></a>lia.faction.hasWhitelist(faction)</span><a class="source-link-button source-link-button--summary" href="https://github.com/LiliaFramework/Lilia/blob/main/gamemode/core/libraries/factions.lua#L1509" target="_blank" rel="noopener noreferrer" onclick="event.stopPropagation()">View Source</a></summary>
<div class="details-content">
<h3 style="margin-bottom: 5px; font-weight: 700;"><a id="liafactionhaswhitelist"></a>Purpose</h3>
<div style="margin-left: 20px; margin-bottom: 20px;">
