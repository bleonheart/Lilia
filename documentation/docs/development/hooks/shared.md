...
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table|nil</a></span> Return a replacement data table, or nil to keep the modified `data`.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> Override for the stamina offset; nil keeps the existing value.</p>
...
<p>After AdvDupe2 completes the paste queue so compatibility state can be reset.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">tbl</span> Paste context provided by AdvDupe2 (first entry is the player).</p>
...
<p>After a bag instance allocates an inventory (on instancing or restore) and access rules are applied.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.item/">Item</a></span> <span class="parameter">bagItem</span> The bag item that owns the inventory.</p>
<p><span class="types"><a class="type" href="/development/libraries/lia.inventory/">Inventory</a></span> <span class="parameter">inventory</span> Child inventory created for the bag.</p>
...
<p>Before a bag item deletes its child inventory (e.g., on item removal).</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.item/">Item</a></span> <span class="parameter">bagItem</span> Bag being removed.</p>
<p><span class="types"><a class="type" href="/development/libraries/lia.inventory/">Inventory</a></span> <span class="parameter">inventory</span> Child inventory scheduled for deletion.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> Positive regen or negative drain applied to the player's stamina pool.</p>
...
<p>Before character transfer commands/classes move a character to another faction/class.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.character/">Character</a></span> <span class="parameter">tChar</span> Character being transferred.</p>
...
<p>Before an outfit applies its model change during equip or removal.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.item/">Item</a></span> <span class="parameter">item</span> Outfit attempting to change the player's model.</p>

<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> Return false to prevent the outfit from changing the model.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> Return false to hide or block selection of the weapon.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> Return false to prevent the knock action.</p>
...
<p><span class="types"><a class="type" href="/development/libraries/lia.item/">Item</a></span> <span class="parameter">item</span> Item instance being rotated.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean|string|nil</a></span> Return false to stop the punch; optionally return a reason string.</p>
...
<p>While building item action menus both client-side (UI) and server-side (validation).</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.item/">Item</a></span> <span class="parameter">tempItem</span> Item being acted on.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> Return false to hide or block the action.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> Return true to force pass, false to force fail, or nil to defer to default logic.</p>
...
<p>Immediately after a command is added to the command library.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">command</span> Command identifier.</p>
...
<p>When a config entry is updated via admin tools or code on the server.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">key</span> Config key that changed.</p>
...
<p>During module loading in the modularity library for each include path.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">path</span> Path of the file being included.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> Maximum allowed level (defaults to infinity).</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> Maximum value allowed at creation; nil falls back to default limits.</p>
...
<p>Whenever stamina is clamped, restored, or initialized.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.character/">Character</a></span> <span class="parameter">char</span> Character whose stamina cap is being read.</p>

<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> Max stamina value; defaults to `DefaultStamina` config when nil.</p>
...
<p><span class="types"><a class="type" href="/development/libraries/lia.character/">Character</a></span> <span class="parameter">char</span> Character whose inventory size is being set.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string|nil</a></span> Name to display; nil lets the default recognition logic run.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> Replacement delay; nil keeps the default.</p>
...
<p>When an item entity is created server-side to set its model.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">itemTable</span> Item definition table.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string|nil</a></span> Model path to use; nil keeps the item's configured model.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> Maximum character slots; nil falls back to `MaxCharacters` config.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> Maximum points allowed; nil keeps the default.</p>
...
<p>When entity meta needs to know if a model is treated as female for voice/animations.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">model</span> Model path being inspected.</p>

<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string|nil</a></span> "female" to treat as female, or nil for default male handling.</p>
...
<p>When a `lia_money` entity initializes and sets its model.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">arg1</span> Amount of currency the entity holds.</p>

<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string|nil</a></span> Model path override; nil falls back to `MoneyModel` config.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table|nil</a></span> Extra dialog options keyed by unique id; nil keeps defaults only.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> New damage value; nil uses `context.damage` or the original.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> Ragdoll duration in seconds; nil uses `PunchRagdollTime` config.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> Replacement price; nil keeps the existing calculation.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> Replacement time; nil keeps the proposed duration.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> Multiplier applied to prices (e.g., 0.9 for 10% off); nil keeps vendor defaults.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string|nil</a></span> Custom weapon name; nil falls back to print name.</p>
...
<p>When an inventory's data key is updated and replicated to clients.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.inventory/">Inventory</a></span> <span class="parameter">instance</span> Inventory whose data changed.</p>
...
<p>After an inventory is created or received over the network.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.inventory/">Inventory</a></span> <span class="parameter">instance</span> Inventory that is ready.</p>
...
<p>After an item successfully enters an inventory, both server- and client-side.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.inventory/">Inventory</a></span> <span class="parameter">inventory</span> Inventory receiving the item.</p>
<p><span class="types"><a class="type" href="/development/libraries/lia.item/">Item</a></span> <span class="parameter">item</span> Item instance added.</p>
...
<p>After an item is removed from an inventory, optionally preserving the instance.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.inventory/">Inventory</a></span> <span class="parameter">inventory</span> Inventory losing the item.</p>
<p><span class="types"><a class="type" href="/development/libraries/lia.item/">Item</a></span> <span class="parameter">instance</span> Item removed.</p>
...
<p>When checking recognition with fake names enabled.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.character/">Character</a></span> <span class="parameter">character</span> Character performing the recognition check.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> Return true if recognized via fake name, false otherwise.</p>
...
<p>Whenever recognition checks are performed for chat or display logic.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.character/">Character</a></span> <span class="parameter">a</span> Character performing the check.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> Return false to force unrecognized, true to force recognized, or nil to use default logic.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> Return true to treat the chat type as requiring recognition.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> Return false to disallow trunk storage on this entity.</p>
...
<p>When an item's data key is updated via networking and propagated to clients.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.item/">Item</a></span> <span class="parameter">item</span> Item whose data changed.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">key</span> Data key.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#2.2">any</a></span> <span class="parameter">oldValue</span> Previous value.</p>
...
<p>During item registration when the base functions table is copied to a new item.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">arg1</span> Functions table for the item being registered.</p>
...
<p>When item data is received over the network and the item is constructed.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.item/">Item</a></span> <span class="parameter">item</span> Newly initialized item instance.</p>
...
<p>After quantity is updated and replicated to clients.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.item/">Item</a></span> <span class="parameter">item</span> Item whose quantity changed.</p>
...
<p>After administration modules finish initializing and privileges are available.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">arg1</span> <span class="optional">optional</span> Admin integration data, if provided.</p>
...
<p>After a char var setter updates a value and broadcasts it.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.character/">Character</a></span> <span class="parameter">character</span> Character whose variable changed.</p>
...
<p>Client-side after a config entry changes and is broadcast.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">key</span> Config key.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#2.2">any</a></span> <span class="parameter">oldValue</span> Previous value.</p>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#2.2">any</a></span> <span class="parameter">value</span> New value.</p>
...
<p><span class="types"><a class="type" href="/development/libraries/lia.item/">Item</a></span> <span class="parameter">item</span> Item instance that was added.</p>
...
<p>When `lia_item` entities are created for dropped or spawned items.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">itemTable</span> Static item definition.</p>
...
<p>When overrides are applied to an item definition at load time.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">item</span> Item definition being overridden.</p>
...
<p>At the end of `lia.item.register` once the item table is stored.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">ITEM</span> Registered item definition.</p>
...
<p><span class="types"><a class="type" href="/development/libraries/lia.item/">Item</a></span> <span class="parameter">item</span> The item that was rotated.</p>
...
<p><span class="types"><a class="type" href="/development/libraries/lia.item/">Item</a></span> <span class="parameter">item</span> The item that was taken.</p>
...
<p>When CAMI/compatibility layers add a new privilege.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">arg1</span> CAMI privilege table or simplified privilege data.</p>
...
<p>When CAMI/compatibility layers unregister a privilege.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">arg1</span> Privilege data being removed.</p>
...
<p>After a theme is applied or a transition completes.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">themeName</span> Name of the theme applied.</p>
...
<p>When an admin integration registers a new group.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">groupName</span> Name of the new group.</p>
...
<p>When an admin integration deletes a group.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">groupName</span> Name of the removed group.</p>
...
<p>After the admin system renames an existing group.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">oldName</span> Previous group name.</p>
...
<p>During faction registration/loading while assembling faction data.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">uniqueID</span> Faction unique identifier.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string|nil</a></span> Replacement description; nil keeps the existing text.</p>
...
<p>During faction registration/loading while choosing models.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">uniqueID</span> Faction identifier.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table|nil</a></span> Replacement models table; nil keeps defaults.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string|nil</a></span> Replacement name; nil keeps the default.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> New respawn time; nil keeps the base value.</p>
...
<p>Immediately after a bag inventory is created or loaded.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="/development/libraries/lia.inventory/">Inventory</a></span> <span class="parameter">inventory</span> Bag inventory being configured.</p>
...
<p>Every time MODULE:SetPositionCallback is called to register a new position feature.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">arg1</span> The list of current feature position types (lia.featurePositionTypes).</p>
...
<p>Typically during module initialization to define new selectable position types in the admin tool.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">name</span> The display name of the position type (e.g., “Faction Spawn Adder”).</p>
