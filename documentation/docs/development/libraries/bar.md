...
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">identifier</span> <span class="optional">optional</span> Unique bar id supplied when added.</p>

<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table|nil</a></span> Stored bar data or nil if not found.</p>
...
<p>Client HUD setup or when creating temporary action/status bars.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.6">function</a></span> <span class="parameter">getValue</span> Returns current fraction (0-1) when called.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> Priority used for the bar.</p>
...
<p>After a timed action completes or when disabling a HUD element.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">identifier</span> Unique id passed during add.</p>
...
<p>Internally from drawAll or for custom bars in panels.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">pos</span> Current value.</p>
...
<p>For timed actions like searching, hacking, or channeling abilities.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">text</span> Label to display.</p>
