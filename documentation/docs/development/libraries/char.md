...
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">charID</span> Character database ID to fetch.</p>
...
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table|nil</a></span> The character object if already cached; otherwise nil while loading.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> Keyed by Player with values of their active character objects.</p>
...
<p>Before loading or accessing a character to avoid duplicate work.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">charID</span> Character database ID to test.</p>

<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> True if the character is cached, otherwise false.</p>
...
<p>After successfully loading or creating a character object.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">id</span> Character database ID.</p>
...
<p>After a character is deleted, unloaded, or no longer needed.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">id</span> Character database ID to remove.</p>
...
<p>During character creation or when rebuilding a character from stored data.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">data</span> Raw character data keyed by variable name.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> New character object.</p>
...
<p>When modules need to react to updates of a given character variable.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">varName</span> Character variable name.</p>
...
<p>During schema load to declare character fields such as name, money, or custom data.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">key</span> Variable identifier.</p>
...
<p>When modules need arbitrary persisted data for a character, optionally scoped to a single key.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">charID</span> Character database ID to query.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table|any|nil</a></span> Table of all key/value pairs, a single value when key is provided, or nil if not found/invalid.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#2.2">any|table|false|nil</a></span> Decoded value for the key, a table of all key/value pairs, false if a keyed lookup is missing, or nil on invalid input.</p>
...
<p>For lookups across connected players when only a Steam identifier is known.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.4">string</a></span> <span class="parameter">steamID</span> SteamID or SteamID64 string.</p>

<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table|nil</a></span> Character object if the player is online and has one loaded, else nil.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> Color table sourced from class definition or team color.</p>
...
<p>During character creation after validation to persist and ready the new character.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.5">table</a></span> <span class="parameter">data</span> Prepared character data including steamID, faction, and name.</p>
...
<p>By admin or player actions that permanently remove a character.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">id</span> Character database ID to delete.</p>
...
<p>Before allowing a character to load or when displaying ban info.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">charID</span> Character database ID.</p>

<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number|nil</a></span> Ban flag/value (0 if not banned), or nil on invalid input.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> True on success, false on immediate failure.</p>
...
<p>When a character is no longer active or needs to be freed from cache.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">charID</span> Character database ID to unload.</p>

<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.2">boolean</a></span> True if a character was unloaded, false if none was loaded.</p>
...
<strong>Returns</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> Count of characters that were unloaded.</p>
...
<p>When a specific character is selected, restored, or fetched server-side.</p>
 ...
 <strong>Parameters</strong>
<p><span class="types"><a class="type" href="https://www.lua.org/manual/5.1/manual.html#5.3">number</a></span> <span class="parameter">charID</span> Character database ID to load.</p>
