...
<div id="aid-generator">
  ...
  <input type="text" id="item-category" placeholder="aid" value="medical" oninput="generateAidItem()">
...
function generateAidItem() {
  ...
  '-- Example: gamemode/items/aid.lua or schema/items.lua',
  '',
...
function fillExampleAidItem() {
  ...
  document.getElementById('item-category').value = 'medical';
