...
|---|---|---|---|---:|
| `ITEM.desc` | Unlocalized string | `A portable storage disk.` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\disks\items\base\disk.lua | 2 |
| `ITEM.name` | Unlocalized string | `Data Disk` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\disks\items\base\disk.lua | 1 |
| `MODULE.desc` | Unlocalized string | `Comprehensive data storage system featuring portable memory disks (64C-1024C capacity) with read/write functionality, password protection, and terminal/decoder integration. Includes physical disk entities, inventory items, and interactive terminals for data manipulation and storage.` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\disks\module.lua | 3 |
| `MODULE.name` | Missing key | `Disks` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\disks\module.lua | 1 |
| `Privilege.Category` | Unlocalized string | `StarWars Terminals` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\disks\entities\entities\decoder2\shared.lua | 5 |
| `Privilege.Category` | Unlocalized string | `StarWars Terminals` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\disks\entities\entities\decoder\shared.lua | 5 |
| `Privilege.Category` | Unlocalized string | `StarWars Terminals` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\disks\entities\entities\disk\shared.lua | 5 |
| `Privilege.Category` | Unlocalized string | `StarWars Terminals` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\disks\module.lua | 41 |
| `data.category` | Missing key | `Disks` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\disks\items\base\disk.lua | 3 |
| `data.desc` | Unlocalized string | `A portable storage disk.` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\disks\items\base\disk.lua | 2 |
| `data.desc` | Unlocalized string | `Comprehensive data storage system featuring portable memory disks (64C-1024C capacity) with read/write functionality, password protection, and terminal/decoder integration. Includes physical disk entities, inventory items, and interactive terminals for data manipulation and storage.` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\disks\module.lua | 3 |
