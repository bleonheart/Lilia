...
|---|---|---|---|---:|
| `FACTION.desc` | Missing key | `Redacted.` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\dt_scrambler\factions\deathtroopers.lua | 2 |
| `FACTION.name` | Unlocalized string | `Death Troopers` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\dt_scrambler\factions\deathtroopers.lua | 1 |
| `MODULE.desc` | Unlocalized string | `Advanced voice communication scrambling system for the Death Trooper faction. Provides secure encrypted voice channels that prevent unauthorized players from hearing DT communications. When enabled, non-Death Trooper listeners cannot hear the voice chat and instead hear randomized static/scrambling sound effects. Authorized Death Trooper members and uplinked players can communicate normally while maintaining operational security. Features real-time voice filtering, multiple scrambling sound effects, and visual voice indicators showing scrambler status.` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\dt_scrambler\module.lua | 3 |
| `MODULE.name` | Unlocalized string | `DT Scrambler` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\dt_scrambler\module.lua | 1 |
| `data.category` | Unlocalized string | `Death Trooper` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\dt_scrambler\pim.lua | 2 |
| `data.category` | Unlocalized string | `Death Trooper` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\dt_scrambler\pim.lua | 16 |
| `data.category` | Unlocalized string | `Death Trooper` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\dt_scrambler\pim.lua | 30 |
| `data.category` | Unlocalized string | `Death Trooper` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\dt_scrambler\pim.lua | 49 |
| `data.desc` | Missing key | `Redacted.` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\dt_scrambler\factions\deathtroopers.lua | 2 |
| `data.desc` | Unlocalized string | `Advanced voice communication scrambling system for the Death Trooper faction. Provides secure encrypted voice channels that prevent unauthorized players from hearing DT communications. When enabled, non-Death Trooper listeners cannot hear the voice chat and instead hear randomized static/scrambling sound effects. Authorized Death Trooper members and uplinked players can communicate normally while maintaining operational security. Features real-time voice filtering, multiple scrambling sound effects, and visual voice indicators showing scrambler status.` | D:\GMOD\Server\garrysmod\gamemodes\lilia_rp\modules\done\dt_scrambler\module.lua | 3 |
