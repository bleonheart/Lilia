...
function PANEL:Init()
    ...
    self.titleLabel = self.container:Add("liaLabel")
    ...
    self.messageLabel = self.container:Add("liaLabel")
    ...
    self.reasonLabel = self.container:Add("liaLabel")
    ...
    self.hintLabel = self.container:Add("liaLabel")
...
function PANEL:UpdateErrorDisplay()
    ...
    if not IsValid(self.errorDisplayLabel) then
        self.errorDisplayLabel = self.container:Add("liaLabel")
