...
function QuickPanel:addButton(text, cb, description)
    ...
    button.Paint = function(panel, w, h)
        ...
        draw.SimpleText(lia.util.wrapText(text, w - 28, "LiliaFont.17", 1, "...")[1] or "", "LiliaFont.17", 14, hasDescription and 17 or h * 0.5, quickPalette.text, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
        if hasDescription then draw.SimpleText(lia.util.wrapText(descriptionText, w - 28, "LiliaFont.15", 1, "...")[1] or "", "LiliaFont.15", 14, 40, quickPalette.textMuted, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER) end
    end
...
function QuickPanel:addSlider(text, cb, val, min, max, dec, description)
    ...
    container.Paint = function(panel, w, h)
        ...
        local border = panel:IsHovered() and quickAlpha(quickPalette.accent, 105) or quickPalette.lineSoft
        drawQuickOutlinedBox(0, 0, w, h, 6, fill, border)
        draw.SimpleText(lia.util.wrapText(text, w - 92, "LiliaFont.17", 1, "...")[1] or "", "LiliaFont.17", 14, 17, quickPalette.text, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
        if hasDescription then draw.SimpleText(lia.util.wrapText(descriptionText, w - 28, "LiliaFont.15", 1, "...")[1] or "", "LiliaFont.15", 14, 39, quickPalette.textMuted, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER) end
    end
...
function QuickPanel:addCheck(text, cb, checked, description)
    ...
    row.Paint = function(panel, w, h)
        ...
        drawQuickOutlinedBox(0, 0, w, h, 6, fill, border)
        draw.SimpleText(lia.util.wrapText(text, textMaxWidth, "LiliaFont.17", 1, "...")[1] or "", "LiliaFont.17", 14, hasDescription and 17 or h * 0.5, quickPalette.text, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
        if hasDescription then
            local lines = lia.util.wrapText(descriptionText, textMaxWidth, "LiliaFont.15", 2, "...")
