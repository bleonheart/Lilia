...
function PANEL:Init()
    ...
    local serverName = header:Add("liaLabel")
    serverName:Dock(TOP)
    ...
    local staffOnline = stats:Add("liaLabel")
    ...
    local playersOnline = stats:Add("liaLabel")
    ...
    local staffOnDuty = stats:Add("liaLabel")
    ...
    for facID, facData in ipairs(lia.faction.indices) do
        ...
        local lbl = facInner:Add("liaLabel")
        ...
        if lia.config.get("ClassHeaders", true) and lia.class and lia.class.list then
            for clsID, clsData in pairs(lia.class.list) do
                ...
                local hlbl = cat.Header:Add("liaLabel")
                hlbl:Dock(LEFT)
...
function PANEL:addPlayer(ply, parent)
    ...
    slot.ping = vgui.Create("liaLabel", slot)
