...
function PANEL:SelectGroup(groupName)
    if self.selectedGroup and self.groupButtons[self.selectedGroup] then
        self.groupButtons[self.selectedGroup]:SetSelected(false)
    end

    self.selectedGroup = groupName

    if self.groupButtons[groupName] then
        self.groupButtons[groupName]:SetSelected(true)
    end

    if self.OnGroupSelected then
        self:OnGroupSelected(groupName)
    end
end
