--[[
    ...
    Purpose:
        Determines whether the local player may use the custom weapon selector while holding the supplied weapon.
    ...
    Parameters:
        weapon (Weapon)
            The local player's currently active weapon when the selection input is received. This may be invalid when no weapon is active.
    ...
    Returns:
        boolean|nil
            Return false to block weapon selection input. Returning nil allows the default behavior.
...
--[[
    ...
    Purpose:
        Determines whether the custom weapon selector may open and draw for a player.
    ...
    Parameters:
        client (Player)
            The local player whose weapon selector is being evaluated.
    ...
    Returns:
        boolean|nil
            Return false to prevent the custom weapon selector from opening or drawing. Returning nil allows it.
...
--[[
    ...
    Purpose:
        Allows clientside code to override the sound and pitch played when the highlighted weapon changes.
    ...
    Returns:
        string|nil, number|nil
            Return a sound path and optional pitch. Missing values use the selector defaults.
...
--[[
    ...
    Purpose:
        Allows clientside code to override the sound and pitch played when the highlighted weapon is selected.
