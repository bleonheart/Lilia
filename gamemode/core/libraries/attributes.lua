...
function lia.attribs.register(uniqueID, data)
    ...
    attribute.name = attribute.name and lia.lang.resolveToken(attribute.name) or L("unknown")
    attribute.desc = attribute.desc and lia.lang.resolveToken(attribute.desc) or L("noDesc")
