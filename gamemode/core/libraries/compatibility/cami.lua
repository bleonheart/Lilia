...
hook.Add("CAMI.PlayerUsergroupChanged", "liaAdminPlyUGChanged", function(ply, _, new)
    ...
    lia.db.updateTable({userGroup = newGroup}, nil, "players", "steamID = " .. lia.db.convertDataType(ply:SteamID()))
end)
...
hook.Add("CAMI.SteamIDUsergroupChanged", "liaAdminSIDUGChanged", function(steamId, _, new)
    ...
    lia.db.updateTable({userGroup = newGroup}, nil, "players", "steamID = " .. lia.db.convertDataType(sid))
end)