...
lia.command.add("fixpac", {
    ...
    onRun = function(client)
        ...
        timer.Simple(1.5, function() if IsValid(client) then client:notifySuccessLocalized("PAC3 has been restarted and caches cleared.") end end)
    end
})
...
lia.command.add("pacenable", {
    ...
    onRun = function(client)
        ...
        client:notifySuccessLocalized("PAC3 has been enabled.")
    end
})
...
lia.command.add("pacdisable", {
    ...
    onRun = function(client)
        ...
        client:notifyInfoLocalized("PAC3 has been disabled.")
    end
})
