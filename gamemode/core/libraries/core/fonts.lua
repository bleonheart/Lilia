...
--[[
    ...
    Returns:
        nil|any
            Returns the result of `lia.error("[Font] Invalid font name or data provided.")` when the font name or data is invalid. Otherwise, this function has no explicit return value.
