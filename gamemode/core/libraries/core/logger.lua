...
local logTypeData = {
    character = {
        ...
        charLoad = function(client, name) return string.format("Player %s loaded character %s", client:steamName(), name) end,
    ...
    admin = {
        ...
        configChange = function(client, name, oldValue, value) return string.format("Configuration changed: '%s' from '%s' to '%s'.", name, tostring(oldValue), tostring(value)) end,
