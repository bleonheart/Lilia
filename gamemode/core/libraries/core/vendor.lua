...
if SERVER then
    ...
    addEditor("name", function() return net.ReadString() end, function(vendor, client, name)
        ...
        vendor:setName(name)
        client:notifyLocalized("Changed vendor name from %s to %s.", getTextValue(oldName), getTextValue(name))
    end)
    ...
    addEditor("desc", function() return net.ReadString() end, function(vendor, client, desc)
        ...
        client:notifyLocalized("Changed vendor description from %s to %s.", getTextValue(oldDesc), getTextValue(desc))
    end)
    ...
    addEditor("mode", function() return net.ReadString(), net.ReadInt(8) end, function(vendor, client, itemType, mode)
        ...
        client:notifyLocalized("Changed mode for %s from %s to %s.", itemName, getModeText(oldMode), getModeText(mode))
    end)
    ...
    addEditor("buyPrice", function() return net.ReadString(), net.ReadInt(32) end, function(vendor, client, itemType, price)
        ...
        client:notifyLocalized("Changed buy price for %s from %s to %s.", itemName, lia.currency.get(oldPrice), lia.currency.get(newPrice))
    end)
    ...
    addEditor("sellPrice", function() return net.ReadString(), net.ReadInt(32) end, function(vendor, client, itemType, price)
        ...
        client:notifyLocalized("Changed sell price for %s from %s to %s.", itemName, lia.currency.get(oldPrice), lia.currency.get(newPrice))
    end)
    ...
    addEditor("stockDisable", function() return net.ReadString() end, function(vendor, client, itemType)
        ...
        client:notifyLocalized("Disabled stock for %s. Previous max stock was %s.", itemName, oldMax or 0)
    end)
    ...
    addEditor("stockMax", function() return net.ReadString(), net.ReadUInt(32) end, function(vendor, client, itemType, value)
        ...
        client:notifyLocalized("Changed max stock for %s from %s to %s.", itemName, oldMax, value)
    end)
    ...
    addEditor("stock", function() return net.ReadString(), net.ReadUInt(32) end, function(vendor, client, itemType, value)
        ...
        client:notifyLocalized("Changed current stock for %s from %s to %s.", itemName, oldStock, newStock)
    end)
    ...
    addEditor("stockEnabled", function() return net.ReadBool() end, function(vendor, client, enabled)
        ...
        client:notifyLocalized("Changed stock option from %s to %s.", getEnabledText(oldEnabled), getEnabledText(enabled))
    end)
    ...
    addEditor("faction", function() return net.ReadUInt(8), net.ReadBool() end, function(vendor, client, factionID, allowed)
        ...
        client:notifyLocalized("Set faction access for %s to %s.", faction and L(faction.name) or tostring(factionID), getEnabledText(allowed))
    end)
    ...
    addEditor("class", function() return net.ReadUInt(8), net.ReadBool() end, function(vendor, client, classID, allowed)
        ...
        client:notifyLocalized("Set class access for %s to %s.", class and L(class.name) or tostring(classID), getEnabledText(allowed))
    end)
    ...
    addEditor("model", function() return net.ReadString() end, function(vendor, client, model)
        ...
        client:notifyLocalized("Changed vendor model from %s to %s.", getTextValue(oldModel), getTextValue(model))
    end)

    addEditor("skin", function() return net.ReadUInt(8) end, function(vendor, client, skin)
        local oldSkin = vendor:GetSkin()
        vendor:setSkin(skin)
        client:notifyLocalized("Changed vendor skin from %s to %s.", oldSkin, skin)
    end)
    ...
    addEditor("bodygroup", function() return net.ReadUInt(8), net.ReadUInt(8) end, function(vendor, client, index, value)
        ...
        client:notifyLocalized("Changed vendor bodygroup %s from %s to %s.", index, oldValue, value)
    end)
    ...
    addEditor("useMoney", function() return net.ReadBool() end, function(vendor, client, useMoney)
        ...
        client:notifyLocalized("Changed vendor money usage from %s to %s.", getEnabledText(oldValue), getEnabledText(useMoney))
    end)
    ...
    addEditor("money", function() return net.ReadUInt(32) end, function(vendor, client, money)
        ...
        client:notifyLocalized("Changed vendor money from %s to %s.", lia.currency.get(oldMoney), lia.currency.get(money))
    end)
    ...
    addEditor("preset", function() return net.ReadString() end, function(vendor, client, preset)
        ...
        client:notifyLocalized("Changed vendor preset from %s to %s.", getTextValue(oldPreset), getTextValue(preset))
    end)
    ...
    addEditor("animation", function()
        ...
        client:notifyLocalized("Changed vendor animation from %s to %s.", getTextValue(oldAnimation), getTextValue(animation))
    end)
else
