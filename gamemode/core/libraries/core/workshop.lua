                        ...
                        mountButton = createWorkshopButton(header, label, workshopMountIcon, true, function()
                            ...
                            steamworks.DownloadUGC(record.id, function(path)
                                ...
                                if not isstring(path) or path == "" then
                                    ...
                                    LocalPlayer():notifyErrorLocalized("Failed to download workshop addon: %s", record.title or record.id)
                                    return
                                end
                                ...
                                LocalPlayer():notifyLocalized("Workshop addon downloaded: %s", record.title or record.id)
