...
function lia.derma.requestDropdown(title, options, callback, defaultValue)
    ...
    frame:MakePopup()
    frame:SetTitle("")
    frame:SetCenterTitle(title or "Select Option")
    frame:ShowAnimation()
    frame:SetZPos(1000)
...
function lia.derma.requestString(title, description, callback, defaultValue, maxLength)
    ...
    frame:MakePopup()
    frame:SetTitle("")
    frame:SetCenterTitle(title or "Enter Text")
    frame:ShowAnimation()
    ...
    descriptionLabel:SetText(description or "Enter value...")
...
function lia.derma.requestOptions(title, subTitle, options, callback, onCancel)
    ...
    frame:MakePopup()
    frame:SetTitle("")
    frame:SetCenterTitle(title or "Select Options")
    if subTitle then
