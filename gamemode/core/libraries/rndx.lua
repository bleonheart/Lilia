...
local function SetupDraw()
	...
	TL, TR, BL, BR = math_clamp(TL, 0, max_rad), math_clamp(TR, 0, max_rad), math_clamp(BL, 0, max_rad), math_clamp(BR, 0, max_rad)
...
function RNDX_Draw(r, x, y, w, h, col, flags)
	return draw_rounded(x, y, w, h, col, flags, r, r, r, r)
end

function RNDX_DrawOutlined(r, x, y, w, h, col, thickness, flags)
	return draw_rounded(x, y, w, h, col, flags, r, r, r, r, nil, thickness or 1)
end

function RNDX_DrawTexture(r, x, y, w, h, col, texture, flags)
	return draw_rounded(x, y, w, h, col, flags, r, r, r, r, texture)
end

function RNDX_DrawMaterial(r, x, y, w, h, col, mat, flags)
	local tex = mat:GetTexture("$basetexture")
	if tex then return RNDX_DrawTexture(r, x, y, w, h, col, tex, flags) end
end

function RNDX_DrawCircle(x, y, r, col, flags)
	return RNDX_Draw(r / 2, x - r / 2, y - r / 2, r, r, col, (flags or 0) + SHAPE_CIRCLE)
end

function RNDX_DrawCircleOutlined(x, y, r, col, thickness, flags)
	return RNDX_DrawOutlined(r / 2, x - r / 2, y - r / 2, r, r, col, thickness, (flags or 0) + SHAPE_CIRCLE)
end

function RNDX_DrawCircleTexture(x, y, r, col, texture, flags)
	return RNDX_DrawTexture(r / 2, x - r / 2, y - r / 2, r, r, col, texture, (flags or 0) + SHAPE_CIRCLE)
end

function RNDX_DrawCircleMaterial(x, y, r, col, mat, flags)
	return RNDX_DrawMaterial(r / 2, x - r / 2, y - r / 2, r, r, col, mat, (flags or 0) + SHAPE_CIRCLE)
end
...
function RNDX_DrawBlur(x, y, w, h, flags, tl, tr, bl, br, thickness)
	RESET_PARAMS()
	if not flags then flags = DEFAULT_DRAW_FLAGS end
	X, Y = x, y
	W, H = w, h
