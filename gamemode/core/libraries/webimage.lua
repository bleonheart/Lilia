...
lia.webimage.register("close_button_clear.png", "https://github.com/LiliaFramework/liaIcons/blob/main/close_button_clear?raw=true")
lia.webimage.register("close_button.png", "https://github.com/LiliaFramework/liaIcons/blob/main/close_button?raw=true")
ensureDir(baseDir)