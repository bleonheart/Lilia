...
local FilesToLoad = {
    ...
    {
        path = "lilia/gamemode/core/hooks/gamemode/shared.lua",
        realm = "shared"
    },
    {
        path = "lilia/gamemode/core/hooks/gamemode/client.lua",
        realm = "client"
    },
    {
        path = "lilia/gamemode/core/hooks/gamemode/server.lua",
        realm = "server"
    },
    {
