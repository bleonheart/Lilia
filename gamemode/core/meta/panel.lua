...
concommand.Add("lia_test_scaling", function()
    if IsValid(_liaTestScalingFrame) then
        _liaTestScalingFrame:Remove()
        return
    end
    ...
    _liaTestScalingFrame = frame
    frame:SetTitle("Scaling Meta Test")
    frame:setScaledSize(800, 700)
    frame:Center()
    frame:MakePopup()
    ...
    infoPanel.Paint = function(_, w, h)
        draw.RoundedBox(4, 0, 0, w, h, lia.color.theme.panel[2] or Color(40, 70, 70))
        draw.SimpleText("Screen: " .. ScrW() .. "x" .. ScrH(), "LiliaFont.16", ScreenScale(10), ScreenScaleH(10), lia.color.theme.text, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
        draw.SimpleText("Base: " .. baseW .. "x" .. baseH, "LiliaFont.16", ScreenScale(10), ScreenScaleH(30), lia.color.theme.text, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
        draw.SimpleText("Scale W: " .. string.format("%.4f", scaleW), "LiliaFont.16", ScreenScale(10), ScreenScaleH(50), lia.color.theme.text, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
        draw.SimpleText("Scale H: " .. string.format("%.4f", scaleH), "LiliaFont.16", ScreenScale(10), ScreenScaleH(70), lia.color.theme.text, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
        draw.SimpleText("Ratio: " .. string.format("%.2f", ScrW() / ScrH()), "LiliaFont.16", ScreenScale(10), ScreenScaleH(90), lia.color.theme.text, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
        draw.SimpleText("Test all scaling metas below", "LiliaFont.14", ScreenScale(10), ScreenScaleH(110), lia.color.theme.accent or lia.color.theme.theme, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
    end

    -- Scroll panel for test panels
    local scroll = vgui.Create("DScrollPanel", frame)
    scroll:Dock(FILL)
    scroll:DockMargin(5, 5, 5, 5)
    -- Test 1: setScaledPos and setScaledSize
    local test1Label = vgui.Create("DLabel", scroll)
    test1Label:SetText("Test 1: setScaledPos() and setScaledSize()")
    test1Label:SetTextColor(lia.color.theme.text)
    test1Label:SetFont("LiliaFont.16")
    test1Label:Dock(TOP)
    test1Label:SetTall(25)
    test1Label:DockMargin(5, 5, 5, 5)
    local test1Panel = vgui.Create("DPanel", scroll)
    test1Panel:setScaledSize(300, 100)
    test1Panel:Dock(TOP)
    test1Panel:DockMargin(5, 0, 5, 10)
    test1Panel.Paint = function(_, w, h)
        draw.RoundedBox(4, 0, 0, w, h, Color(100, 150, 255, 100))
        draw.SimpleText("setScaledSize(300, 100)", "LiliaFont.14", w / 2, h / 2, lia.color.theme.text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    -- Test 2: SetSize (auto-scaling)
    local test2Label = vgui.Create("DLabel", scroll)
    test2Label:SetText("Test 2: SetSize() auto-scaling")
    test2Label:SetTextColor(lia.color.theme.text)
    test2Label:SetFont("LiliaFont.16")
    test2Label:Dock(TOP)
    test2Label:SetTall(25)
    test2Label:DockMargin(5, 5, 5, 5)
    local test2Panel = vgui.Create("DPanel", scroll)
    test2Panel:SetSize(400, 80) -- Should auto-scale
    test2Panel:Dock(TOP)
    test2Panel:DockMargin(5, 0, 5, 10)
    test2Panel.Paint = function(_, w, h)
        draw.RoundedBox(4, 0, 0, w, h, Color(255, 150, 100, 100))
        draw.SimpleText("SetSize(400, 80) - auto-scaled", "LiliaFont.14", w / 2, h / 2, lia.color.theme.text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    -- Test 3: SetWide and SetTall (auto-scaling)
    local test3Label = vgui.Create("DLabel", scroll)
    test3Label:SetText("Test 3: SetWide() and SetTall() auto-scaling")
    test3Label:SetTextColor(lia.color.theme.text)
    test3Label:SetFont("LiliaFont.16")
    test3Label:Dock(TOP)
    test3Label:SetTall(25)
    test3Label:DockMargin(5, 5, 5, 5)
    local test3Panel = vgui.Create("DPanel", scroll)
    test3Panel:SetWide(350) -- Should auto-scale
    test3Panel:SetTall(90) -- Should auto-scale
    test3Panel:Dock(TOP)
    test3Panel:DockMargin(5, 0, 5, 10)
    test3Panel.Paint = function(_, w, h)
        draw.RoundedBox(4, 0, 0, w, h, Color(100, 255, 150, 100))
        draw.SimpleText("SetWide(350) SetTall(90) - auto-scaled", "LiliaFont.14", w / 2, h / 2, lia.color.theme.text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    -- Test 4: DockPadding (auto-scaling)
    local test4Label = vgui.Create("DLabel", scroll)
    test4Label:SetText("Test 4: DockPadding() auto-scaling")
    test4Label:SetTextColor(lia.color.theme.text)
    test4Label:SetFont("LiliaFont.16")
    test4Label:Dock(TOP)
    test4Label:SetTall(25)
    test4Label:DockMargin(5, 5, 5, 5)
    local test4Panel = vgui.Create("DPanel", scroll)
    test4Panel:SetSize(500, 120)
    test4Panel:Dock(TOP)
    test4Panel:DockMargin(5, 0, 5, 10)
    test4Panel:DockPadding(20, 15, 20, 15) -- Should auto-scale
    test4Panel.Paint = function(_, w, h)
        draw.RoundedBox(4, 0, 0, w, h, Color(255, 255, 100, 100))
        local padLeft, padTop, padRight, padBottom = test4Panel:GetDockPadding()
        draw.SimpleText("DockPadding(20, 15, 20, 15) - auto-scaled", "LiliaFont.14", w / 2, h / 2 - 10, lia.color.theme.text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        draw.SimpleText(string.format("Actual: %.1f, %.1f, %.1f, %.1f", padLeft, padTop, padRight, padBottom), "LiliaFont.12", w / 2, h / 2 + 10, lia.color.theme.text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    -- Test 5: DockMargin (auto-scaling)
    local test5Label = vgui.Create("DLabel", scroll)
    test5Label:SetText("Test 5: DockMargin() auto-scaling")
    test5Label:SetTextColor(lia.color.theme.text)
    test5Label:SetFont("LiliaFont.16")
    test5Label:Dock(TOP)
    test5Label:SetTall(25)
    test5Label:DockMargin(5, 5, 5, 5)
    local test5Container = vgui.Create("DPanel", scroll)
    test5Container:SetSize(500, 100)
    test5Container:Dock(TOP)
    test5Container:DockMargin(5, 0, 5, 10)
    test5Container.Paint = function(_, w, h) draw.RoundedBox(4, 0, 0, w, h, Color(200, 200, 200, 50)) end
    local test5Panel = vgui.Create("DPanel", test5Container)
    test5Panel:Dock(FILL)
    test5Panel:DockMargin(25, 10, 25, 10) -- Should auto-scale
    test5Panel.Paint = function(_, w, h)
        draw.RoundedBox(4, 0, 0, w, h, Color(255, 100, 255, 100))
        draw.SimpleText("DockMargin(25, 10, 25, 10) - auto-scaled", "LiliaFont.14", w / 2, h / 2, lia.color.theme.text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    -- Test 6: SetMinWidth and SetMinHeight (auto-scaling)
    local test6Label = vgui.Create("DLabel", scroll)
    test6Label:SetText("Test 6: SetMinWidth() and SetMinHeight() auto-scaling")
    test6Label:SetTextColor(lia.color.theme.text)
    test6Label:SetFont("LiliaFont.16")
    test6Label:Dock(TOP)
    test6Label:SetTall(25)
    test6Label:DockMargin(5, 5, 5, 5)
    local test6Panel = vgui.Create("DPanel", scroll)
    if test6Panel.SetMinWidth then
        test6Panel:SetMinWidth(200) -- Should auto-scale
    end

    if test6Panel.SetMinHeight then
        test6Panel:SetMinHeight(60) -- Should auto-scale
    end

    test6Panel:SetSize(150, 40) -- Smaller than min, should expand
    test6Panel:Dock(TOP)
    test6Panel:DockMargin(5, 0, 5, 10)
    test6Panel.Paint = function(_, w, h)
        draw.RoundedBox(4, 0, 0, w, h, Color(100, 255, 255, 100))
        local hasMin = test6Panel.SetMinWidth and test6Panel.SetMinHeight
        draw.SimpleText(hasMin and "SetMinWidth(200) SetMinHeight(60)" or "SetMinWidth/SetMinHeight not available", "LiliaFont.14", w / 2, h / 2, lia.color.theme.text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        draw.SimpleText(string.format("Size: %.0fx%.0f%s", w, h, hasMin and " (min enforced)" or ""), "LiliaFont.12", w / 2, h / 2 + 15, lia.color.theme.text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    -- Test 7: SetMaxWidth and SetMaxHeight (auto-scaling)
    local test7Label = vgui.Create("DLabel", scroll)
    test7Label:SetText("Test 7: SetMaxWidth() and SetMaxHeight() auto-scaling")
    test7Label:SetTextColor(lia.color.theme.text)
    test7Label:SetFont("LiliaFont.16")
    test7Label:Dock(TOP)
    test7Label:SetTall(25)
    test7Label:DockMargin(5, 5, 5, 5)
    local test7Panel = vgui.Create("DPanel", scroll)
    if test7Panel.SetMaxWidth then
        test7Panel:SetMaxWidth(250) -- Should auto-scale
    end

    if test7Panel.SetMaxHeight then
        test7Panel:SetMaxHeight(70) -- Should auto-scale
    end

    test7Panel:SetSize(400, 100) -- Larger than max, should shrink
    test7Panel:Dock(TOP)
    test7Panel:DockMargin(5, 0, 5, 10)
    test7Panel.Paint = function(_, w, h)
        draw.RoundedBox(4, 0, 0, w, h, Color(255, 200, 100, 100))
        local hasMax = test7Panel.SetMaxWidth and test7Panel.SetMaxHeight
        draw.SimpleText(hasMax and "SetMaxWidth(250) SetMaxHeight(70)" or "SetMaxWidth/SetMaxHeight not available", "LiliaFont.14", w / 2, h / 2, lia.color.theme.text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        draw.SimpleText(string.format("Size: %.0fx%.0f%s", w, h, hasMax and " (max enforced)" or ""), "LiliaFont.12", w / 2, h / 2 + 15, lia.color.theme.text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    -- Test 8: Combined test with setScaledPos
    local test8Label = vgui.Create("DLabel", scroll)
    test8Label:SetText("Test 8: setScaledPos() positioning")
    test8Label:SetTextColor(lia.color.theme.text)
    test8Label:SetFont("LiliaFont.16")
    test8Label:Dock(TOP)
    test8Label:SetTall(25)
    test8Label:DockMargin(5, 5, 5, 5)
    local test8Container = vgui.Create("DPanel", scroll)
    test8Container:SetSize(500, 150)
    test8Container:Dock(TOP)
    test8Container:DockMargin(5, 0, 5, 10)
    test8Container.Paint = function(_, w, h) draw.RoundedBox(4, 0, 0, w, h, Color(200, 200, 200, 50)) end
    local test8Panel = vgui.Create("DPanel", test8Container)
    test8Panel:setScaledSize(100, 80)
    test8Panel:setScaledPos(50, 30) -- Should be scaled
    test8Panel.Paint = function(_, w, h)
        draw.RoundedBox(4, 0, 0, w, h, Color(150, 100, 255, 150))
        draw.SimpleText("setScaledPos(50, 30)", "LiliaFont.12", w / 2, h / 2, lia.color.theme.text, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    -- Summary
    local summaryLabel = vgui.Create("DLabel", scroll)
    summaryLabel:SetText("Summary: All scaling metas tested. Check console for details.")
    summaryLabel:SetTextColor(lia.color.theme.accent or lia.color.theme.theme)
    summaryLabel:SetFont("LiliaFont.14")
    summaryLabel:Dock(TOP)
    summaryLabel:SetTall(30)
    summaryLabel:DockMargin(5, 10, 5, 5)
    -- Print test results to console
    print("=== Scaling Meta Test Results ===")
    print("Screen Resolution: " .. ScrW() .. "x" .. ScrH())
    print("Base Resolution: " .. baseW .. "x" .. baseH)
    print("Scale Factors: W=" .. string.format("%.4f", scaleW) .. ", H=" .. string.format("%.4f", scaleH))
    print("")
    print("Test 1: setScaledSize(300, 100)")
    print("  Expected: " .. string.format("%.1f", 300 * scaleW) .. "x" .. string.format("%.1f", 100 * scaleH))
    print("  Actual: " .. test1Panel:GetWide() .. "x" .. test1Panel:GetTall())
    print("")
    print("Test 2: SetSize(400, 80) - auto-scaled")
    print("  Expected: " .. string.format("%.1f", 400 * scaleW) .. "x" .. string.format("%.1f", 80 * scaleH))
    print("  Actual: " .. test2Panel:GetWide() .. "x" .. test2Panel:GetTall())
    print("")
    print("Test 3: SetWide(350) SetTall(90) - auto-scaled")
    print("  Expected: " .. string.format("%.1f", 350 * scaleW) .. "x" .. string.format("%.1f", 90 * scaleH))
    print("  Actual: " .. test3Panel:GetWide() .. "x" .. test3Panel:GetTall())
    print("")
    print("All scaling metas have been tested!")
end)