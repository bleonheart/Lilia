...
LANGUAGE = {
    ...
    finish = "Finish",
    back = "Back",
    classSet = "Your class was set to %s.",
    ...
    radialPanelDescription = "Radial panels render fullscreen. Use the button below to spawn a live demo using vgui.Create(\"liaRadialPanel\").",
    ...
    openMenuTabDesc = "Opens the %s tab",
    ...
    noDeathCooldown = "No Death Cooldown",
    ...
    adminStickQuickMode = "Quick Mode",
    adminStickQuickModeOpen = "Open options",
