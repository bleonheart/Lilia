...
LANGUAGE = {
    ...
    loadYourMainCharacter = "Load your main character",
    loadYourStaffCharacter = "Load your staff character",
    createAStaffCharacter = "Create a staff character",
    ...
    weaponDefaultDescription = "A weapon",
    weaponDefaultCategory = "Weapons",
    ...
    adminHUDOwnerWorld = "Owner: World",
    ...
    assetStatisticsImages = "Images: %d downloaded | %d stored",
    assetStatisticsSounds = "Sounds: %d downloaded | %d stored",
...
if LANGUAGE then
    LANGUAGE["adminStickKickPlayerName"] = LANGUAGE["adminStickKickName"]
    LANGUAGE["adminStickSubCategoryActions"] = LANGUAGE["actions"]
    LANGUAGE["adminStickSubCategoryClassWhitelist"] = LANGUAGE["adminStickClassWhitelistName"]
    LANGUAGE["adminStickSubCategoryFactionWhitelist"] = LANGUAGE["adminStickFactionWhitelistName"]
    LANGUAGE["adminStickSubCategoryMiscellaneous"] = LANGUAGE["adminStickCategoryMiscellaneous"]
    LANGUAGE["administrationModuleName"] = LANGUAGE["adminStickCategoryAdministration"]
    LANGUAGE["attributes"] = LANGUAGE["adminStickSubCategoryAttributes"]
    LANGUAGE["attributesModuleName"] = LANGUAGE["adminStickSubCategoryAttributes"]
    LANGUAGE["author"] = LANGUAGE["Author"]
    LANGUAGE["banOOCStickName"] = LANGUAGE["banOOC"]
    LANGUAGE["botsSpawnMultipleTitle"] = LANGUAGE["botsSpawnMultipleOption"]
    LANGUAGE["botsSpawnTitle"] = LANGUAGE["botsSpawnOption"]
    LANGUAGE["category"] = LANGUAGE["Category"]
    LANGUAGE["categoryAdministration"] = LANGUAGE["adminStickCategoryAdministration"]
    LANGUAGE["categoryLiliaESP"] = LANGUAGE["categoryESP"]
    LANGUAGE["categoryLiliaGeneral"] = LANGUAGE["categoryGeneral"]
    LANGUAGE["categoryServer"] = LANGUAGE["adminStickCategoryServer"]
    LANGUAGE["categoryUsergroups"] = LANGUAGE["adminStickCategoryPermissions"]
    LANGUAGE["charFlagsTitle"] = LANGUAGE["adminStickSubCategoryCharacterFlags"]
    LANGUAGE["character"] = LANGUAGE["categoryCharacter"]
    LANGUAGE["characterManagement"] = LANGUAGE["adminStickCategoryCharacterManagement"]
    LANGUAGE["classes"] = LANGUAGE["adminStickSubCategoryClasses"]
    LANGUAGE["combinedDownloaded"] = LANGUAGE["assetStatisticsCombined"]
    LANGUAGE["commands"] = LANGUAGE["adminStickSubCategoryCommands"]
    LANGUAGE["confirmButton"] = LANGUAGE["confirm"]
    LANGUAGE["contact"] = LANGUAGE["Contact"]
    LANGUAGE["core"] = LANGUAGE["categoryConfiguration"]
    LANGUAGE["description"] = LANGUAGE["desc"]
    LANGUAGE["discordWarningSystemAdmin"] = LANGUAGE["admin"]
    LANGUAGE["doorActions"] = LANGUAGE["adminStickSubCategoryDoorActions"]
    LANGUAGE["doorIDColumn"] = LANGUAGE["doorID"]
    LANGUAGE["doorIDProperty"] = LANGUAGE["doorID"]
    LANGUAGE["doorInfoDisabled"] = LANGUAGE["disabled"]
    LANGUAGE["doorInformation"] = LANGUAGE["adminStickSubCategoryDoorInformation"]
    LANGUAGE["doorMaintenance"] = LANGUAGE["adminStickSubCategoryDoorMaintenance"]
    LANGUAGE["doorManagement"] = LANGUAGE["adminStickCategoryDoorManagement"]
    LANGUAGE["doorSettings"] = LANGUAGE["adminStickSubCategoryDoorSettings"]
    LANGUAGE["doorbuy"] = LANGUAGE["buyDoor"]
    LANGUAGE["doorsettitle"] = LANGUAGE["adminStickSetDoorTitleName"]
    LANGUAGE["f1MenuModuleName"] = LANGUAGE["f1Menu"]
    LANGUAGE["factionManagement"] = LANGUAGE["categoryFactionManagement"]
    LANGUAGE["factions"] = LANGUAGE["adminStickSubCategoryFactions"]
    LANGUAGE["failedToQueryTable"] = LANGUAGE["failedQueryTable"]
    LANGUAGE["failedToReadSnapshotFile"] = LANGUAGE["failedReadSnapshot"]
    LANGUAGE["flags"] = LANGUAGE["adminStickSubCategoryFlags"]
    LANGUAGE["gameBunnyHop"] = LANGUAGE["bunnyHop"]
    LANGUAGE["gameSAMAdminMod"] = LANGUAGE["categorySAM"]
    LANGUAGE["genericPlayer"] = LANGUAGE["discordAntiCheatPlayer"]
    LANGUAGE["idPrefix"] = LANGUAGE["doorIDLabel"]
    LANGUAGE["imagesDownloaded"] = LANGUAGE["assetStatisticsImages"]
    LANGUAGE["information"] = LANGUAGE["adminStickSubCategoryInformation"]
    LANGUAGE["instructions"] = LANGUAGE["Instructions"]
    LANGUAGE["inventory"] = LANGUAGE["inv"]
    LANGUAGE["inventoryModuleName"] = LANGUAGE["inv"]
    LANGUAGE["itemUniqueIDString"] = LANGUAGE["classUniqueIDString"]
    LANGUAGE["items"] = LANGUAGE["adminStickCategoryItems"]
    LANGUAGE["lilia"] = LANGUAGE["discordRelayLilia"]
    LANGUAGE["liliaRadial"] = LANGUAGE["discordRelayLilia"]
    LANGUAGE["liliaTableErrorInvalidArgs"] = LANGUAGE["liaTableErrorInvalidArgs"]
    LANGUAGE["liliaTableErrorInvalidArgsRussian"] = LANGUAGE["liaTableErrorInvalidArgs"]
    LANGUAGE["lockStorage"] = LANGUAGE["lock"]
    LANGUAGE["logAdmin"] = LANGUAGE["admin"]
    LANGUAGE["logCategory"] = LANGUAGE["Category"]
    LANGUAGE["logDoorToggleOwnable"] = LANGUAGE["logDoorSetHidden"]
    LANGUAGE["logInformation"] = LANGUAGE["adminStickSubCategoryInformation"]
    LANGUAGE["mainMenuCharBGInputDisabledDesc"] = LANGUAGE["charMenuBGInputDisabledDesc"]
    LANGUAGE["mainMenuModuleName"] = LANGUAGE["mainMenu"]
    LANGUAGE["manageSitrooms"] = LANGUAGE["manageSitRooms"]
    LANGUAGE["menu"] = LANGUAGE["categoryMenu"]
    LANGUAGE["menuTitle"] = LANGUAGE["categoryMenu"]
    LANGUAGE["message"] = LANGUAGE["discordTicketSystemMessage"]
    LANGUAGE["misc"] = LANGUAGE["adminStickCategoryMiscellaneous"]
    LANGUAGE["moderationTools"] = LANGUAGE["adminStickSubCategoryModerationTools"]
    LANGUAGE["moduleDoorsName"] = LANGUAGE["doorsModuleName"]
    LANGUAGE["modulePermissionsName"] = LANGUAGE["adminStickCategoryPermissions"]
    LANGUAGE["name"] = LANGUAGE["PrintName"]
    LANGUAGE["nextPage"] = LANGUAGE["next"]
    LANGUAGE["noOptionsAvailable"] = LANGUAGE["adminStickNoOptions"]
    LANGUAGE["notAvailable"] = LANGUAGE["na"]
    LANGUAGE["npc"] = LANGUAGE["defaultNPCName"]
    LANGUAGE["npcChangeTypeTitle"] = LANGUAGE["adminStickChangeNPCType"]
    LANGUAGE["panelTypeCount"] = LANGUAGE["indexedFileEntry"]
    LANGUAGE["permissions"] = LANGUAGE["adminStickCategoryPermissions"]
    LANGUAGE["permissionsModuleName"] = LANGUAGE["adminStickCategoryPermissions"]
    LANGUAGE["player"] = LANGUAGE["discordAntiCheatPlayer"]
    LANGUAGE["playerInformation"] = LANGUAGE["adminStickCategoryPlayerInformation"]
    LANGUAGE["playerinformation"] = LANGUAGE["adminStickCategoryPlayerInformation"]
    LANGUAGE["playtimeDaysHoursMinutes"] = LANGUAGE["daysHoursMinutes"]
    LANGUAGE["protectionModuleName"] = LANGUAGE["protection"]
    LANGUAGE["purpose"] = LANGUAGE["Purpose"]
    LANGUAGE["realisticDamageModuleName"] = LANGUAGE["gameRealisticDamage"]
    LANGUAGE["reason"] = LANGUAGE["discordWarningSystemReason"]
    LANGUAGE["recognition"] = LANGUAGE["categoryRecognition"]
    LANGUAGE["recognitionModuleName"] = LANGUAGE["categoryRecognition"]
    LANGUAGE["requester"] = LANGUAGE["discordTicketSystemRequester"]
    LANGUAGE["returnText"] = LANGUAGE["returnButton"]
    LANGUAGE["salaryWord"] = LANGUAGE["categorySalary"]
    LANGUAGE["sampleRoleEngineer"] = LANGUAGE["engineer"]
    LANGUAGE["saved"] = LANGUAGE["dataSaved"]
    LANGUAGE["scoreboardModuleName"] = LANGUAGE["scoreboard"]
    LANGUAGE["sell"] = LANGUAGE["doorSell"]
    LANGUAGE["settings"] = LANGUAGE["adminStickSubCategorySettings"]
    LANGUAGE["simfphysVehicles"] = LANGUAGE["gameSimfphysVehicles"]
    LANGUAGE["sitAnywhere"] = LANGUAGE["gameSitAnywhere"]
    LANGUAGE["soundsDownloaded"] = LANGUAGE["assetStatisticsSounds"]
    LANGUAGE["spawnmenuAll"] = LANGUAGE["all"]
    LANGUAGE["storageDataMustBeTable"] = LANGUAGE["dataMustBeTable"]
    LANGUAGE["storageInvDataRequired"] = LANGUAGE["inventoryDataRequired"]
    LANGUAGE["storageInvTypeRequired"] = LANGUAGE["inventoryTypeRequired"]
    LANGUAGE["storageModelMustBeString"] = LANGUAGE["modelMustBeString"]
    LANGUAGE["storageModuleName"] = LANGUAGE["storage"]
    LANGUAGE["suggestsDataCorruptionClearingClasses"] = LANGUAGE["doorDataCorruptionClearing"]
    LANGUAGE["table"] = LANGUAGE["dbTableColumn"]
    LANGUAGE["themeDarkMono"] = LANGUAGE["fontDarkMono"]
    LANGUAGE["themeSapphire"] = LANGUAGE["sapphire"]
    LANGUAGE["ticketsModuleName"] = LANGUAGE["tickets"]
    LANGUAGE["tools"] = LANGUAGE["categoryTools"]
    LANGUAGE["uiLiliaSkin"] = LANGUAGE["liliaSkin"]
    LANGUAGE["ui_health_low"] = LANGUAGE["health_low"]
    LANGUAGE["unknownFile"] = LANGUAGE["discordWarningSystemUnknown"]
    LANGUAGE["unsorted"] = LANGUAGE["categoryUnsorted"]
    LANGUAGE["userGroups"] = LANGUAGE["adminStickCategoryPermissions"]
    LANGUAGE["vendor"] = LANGUAGE["entityVendorName"]
    LANGUAGE["vendorModelString"] = LANGUAGE["modelMustBeString"]
    LANGUAGE["vendorModuleName"] = LANGUAGE["entityVendorName"]
    LANGUAGE["vendorName"] = LANGUAGE["PrintName"]
    LANGUAGE["vendorNotAvailable"] = LANGUAGE["na"]
    LANGUAGE["vendorPresetBuyOnly"] = LANGUAGE["buyOnly"]
    LANGUAGE["vendorPresetSellOnly"] = LANGUAGE["sellOnly"]
    LANGUAGE["vendorUnknownMode"] = LANGUAGE["discordWarningSystemUnknown"]
    LANGUAGE["warning"] = LANGUAGE["logWarning"]
    LANGUAGE["warningCount"] = LANGUAGE["discordWarningSystemWarningCount"]
    LANGUAGE["warning_generic"] = LANGUAGE["logWarning"]
    LANGUAGE["warning_health_low"] = LANGUAGE["health_low"]
    LANGUAGE["warnings"] = LANGUAGE["adminStickCategoryWarnings"]
    LANGUAGE["warnsModuleName"] = LANGUAGE["adminStickCategoryWarnings"]
    LANGUAGE["weaponItemCategory"] = LANGUAGE["Category"]
    LANGUAGE["weaponItemDescription"] = LANGUAGE["desc"]
    LANGUAGE["weaponItemHeight"] = LANGUAGE["thirdPersonHeight"]
    LANGUAGE["weaponItemModel"] = LANGUAGE["model"]
    LANGUAGE["weaponItemName"] = LANGUAGE["PrintName"]
    LANGUAGE["weaponItemPrice"] = LANGUAGE["price"]
    LANGUAGE["weapons"] = LANGUAGE["weaponDefaultCategory"]
    LANGUAGE["workshop"] = LANGUAGE["categoryWorkshop"]
end
