...
LANGUAGE = {
    ...
    blacklistedEntity = "Blacklisted Entity!",
    ...
    groupCreatedNamed = "Group '%s' created.",
    groupRemovedNamed = "Group '%s' removed.",
    ...
    kick = "Kick",
    kickPlayerConfirm = "Are you sure you want to kick this player?",
    confirm = "Confirm",
    rename = "Rename",
    ...
    deleteGroupQuery = "Delete group '%s'?",
    chooseGroup = "Choose a group",
    inheritGroupTitle = "Choose Inheritance",
    selectInheritancePrompt = "Select a group to inherit from:",
    banCharacter = "Ban Character",
    unbanCharacter = "Unban Character",
    openList = "Open List",
    steamIDName = "SteamID/Name",
    ...
    charVoiceToggleDesc = "Toggles voice chat ban for the specified player.",
...
Reload: Drop]],
    ...
    noCharactersFound = "No characters found for this player.",
    playerUnbanned = "Player unbanned",
    shortAdmin = "Admin",
    kickedFromFaction = "You were kicked from your faction!",
    offlineBanKick = "You have been banned.",
    accessDeniedBots = "Access denied: bots have no privileges.",
    accessDeniedGroupNotRegistered = "Access denied: group '%s' is not registered.",
    accessDeniedLacksPrivilege = "Access denied: group '%s' lacks '%s' privilege.",
    doorSaveData = "Saved door data for %s door(s).",
