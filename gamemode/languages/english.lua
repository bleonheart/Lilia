...
LANGUAGE = {
    ...
    noPermissionToChangeThemes = "You don't have permission to change themes.",
    themes = "Themes",
    themeDark = "Dark",
    ...
    selectedTheme = "Selected theme: %s (#%s)",
    masterVolume = "Master Volume",
    currentValue = "Current value: %s%%",
    notificationsEnabled = "Notifications enabled",
    notificationsDisabled = "Notifications disabled",
    notificationsDesc = "Show popups for important server events.",
    invalidEntity = "Invalid entity",
    storageContainer = "Storage Container",
    storageInitServerOnly = "Storage initialization only available on server",
    failedToSpawnItem = "Failed to spawn item: %s",
    unknownError = "Unknown error",
    imageDownload = "[Image Download]",
    failedToDownloadImage = "Failed to download: %s (%s)",
    liliaFrameDescription = "Use Lilia frames to host complex layouts. Buttons, tables and other controls can live inside this container.",
    ...
    surfaceSetFontNil = "surface.SetFont called with nil! Using fallback font",
    shadowedBlurredRectangleError = "You can't get the material of a shadowed or blurred rectangle!",
    liliaTableErrorInvalidArgsRussian = "liaTable Error: Неверное количество аргументов",
...
Reload: Drop]],
    ...
    doorGroupColumnAlreadyExists = "door_group column already exists.",
    failedToDownloadSound = "Failed to download: %s (%s)",
    assetsDownloadWarning = "Warning: %d %s failed to download. Check console for details.",
    ...
    moveItemsBack = "Move Items Back %sx%s",
    ...
    themeUpdatedTo = "Theme updated to: %s",
    ...
    dataMustBeTable = "Data must be a table",
    failedToCheckCorruptedDoorData = "Failed to check for corrupted door data: %s",
    failedToDeserializeClassesForDoor = "Failed to deserialize classes for door ",
    failedToDeserializeFactionsForDoor = "Failed to deserialize factions for door ",
    ...
    placeWaypoint = "Place a waypoint",
    ...
    failedToParseJSONData = "Failed to parse JSON data:",
    ...
    invalidNetTarget = "Invalid target for lia.net.send",
    invalidPrivilegeIDType = "Command '%s' has invalid privilege ID type: %s",
    viewEntityTab = "View Entity Tab",
    teleportToEntity = "Teleport to Entity",
    bypassNoclipShooting = "Bypass Noclip Shooting Restriction",
    notProvided = "not provided",
    staffCharacterDiscordSteamID = "A Staff Character, Discord: %s, SteamID: %s",
    canRemoveWarns = "Can Remove Warns",
    viewPlayerWarnings = "View Player Warnings",
    canUseItemSpawner = "Can Use Item Spawner",
    canSeeLogs = "Can See Logs",
    ...
    physgunPickup = "Physgun Pickup",
    canAccessItemInformations = "Can Access Item Informations",
    physgunPickupRestrictedEntities = "Physgun Pickup Restricted Entities",
    physgunPickupVehicles = "Physgun Pickup Vehicles",
    cantBeGrabbedPhysgun = "Can't Be Grabbed Physgun",
    canPhysgunReload = "Can Physgun Reload",
    noClipOutsideStaff = "No Clip Outside Staff",
    noClipESPOffsetStaff = "No Clip ESP Offset Staff",
    canPropertyWorldEntities = "Can Property World Entities",
    manageVehicleBlacklist = "Manage Vehicle Blacklist",
    canSpawnRagdolls = "Can Spawn Ragdolls",
    canSpawnSWEPs = "Can Spawn SWEPs",
    ...
    canRemoveWorldEntities = "Can Remove World Entities",
    alwaysSeeTickets = "Always See Tickets",
    alwaysSpawnAdminStick = "Always Spawn Admin Stick",
    managePropBlacklist = "Manage Prop Blacklist",
    manageVehicleBlacklist = "Manage Vehicle Blacklist",
    accessEditConfigurationMenu = "Access Edit Configuration Menu",
    ...
    canAccessFlagManagement = "Can Access Flag Management",
    createStaffCharacter = "Create Staff Character",
    canBypassSAMFactionWhitelist = "Can Bypass SAM Faction Whitelist",
    canEditSimfphysCars = "Can Edit Simfphys Cars",
    canSeeSAMNotificationsOutsideStaff = "Can See SAM Notifications Outside Staff",
    checkInventories = "Check Inventories",
    manageAttributes = "Manage Attributes",
    manageCharacterInformation = "Manage Character Information",
    manageCharacters = "Manage Characters",
    ...
    manageDoors = "Manage Doors",
    manageFlags = "Manage Flags",
    manageSitRooms = "Manage Sit Rooms",
    manageTransfers = "Manage Transfers",
    receiveCheaterNotifications = "Receive Cheater Notifications",
    stopSoundForEveryone = "Stop Sound For Everyone",
    useDisallowedTools = "Use Disallowed Tools",
    ...
    localEventChat = "Local Event Chat",
    eventChat = "Event Chat",
    accessHelpChat = "Access Help Chat",
    canSpawnStorage = "Can Spawn Storage",
    canEditVendors = "Can Edit Vendors",
    canCreateVendorPresets = "Can Create Vendor Presets",
    canSeeAltingNotifications = "Can See Alting Notifications",
    urlNotValidString = "URL is not a valid string",
    urlMustStartWithHttp = "URL must start with http:// or https://",
    urlNoValidDomain = "URL has no valid domain",
    localhostUrlsNotAllowed = "localhost URLs are not allowed",
    ...
    invalidDoorPresetData = "Invalid door preset data: %s",
    invalidPresetDataType = "Invalid preset data type: %s",
    liaTableErrorInvalidArgs = "liaTable Error: Invalid number of arguments",
    loadedPresetForDoor = "Loaded preset for door %s",
    noDoorEntityFound = "No door entity found",
    noPresetDataFound = "No preset data found",
    presetApplicationFailed = "Preset application failed",
    unknownError = "Unknown error",
    id = "ID",
    minAccess = "Min Access",
    category = "Category",
    ...
    failedToCheckDoorGroupColumn = "Failed to check door_group column",
    -- UI strings
    copy = "Copy",
    ...
    keybindPressErrorFor = "Keybind press error for",
    keybindReleaseErrorFor = "Keybind release error for",
    liliaFrameNotification = "Lilia frame notification!",
    missingExpectedColumn = "Missing expected column:",
    processingWithMaxConcurrentDownloads = "Processing with max concurrent downloads:",
    warningAssetsFailedToDownload = "WARNING: Some assets failed to download. Check console output above for details.",
    ...
    liliaServerPasswordNotSet = "[Lilia] Server password is not set.",
    ...
    liaTable = "[liaTable]",
    doorsAddPresetMissingParameters = "lia.doors.AddPreset: Missing required parameters (mapName, presetData)",
    keybindAddInvalidCallbackFormat = "lia.keybind.add: Invalid callback format in lia.keybind.add of function",
    hasType = "has type",
    expected = "expected",
    skippingDoorRecordWithInvalidID = "Skipping door record with invalid ID:",
    entityIsNotADoorSkipping = "Entity is not a door, skipping",
    doorHasCoordinateDataInFactionsColumn = "Door has coordinate-like data in factions column:",
    ...
    loggingModuleName = "Logging",
    mainMenuModuleName = "MainMenu",
    ...
    vendorModuleName = "Vendors",
    warnsModuleName = "Warns",
    itemSpawnerModuleName = "Item Spawner",
    ...
    liaDoorsTableColumns = "lia_doors table columns",
    startedRedownloadingStoredWebImages = "Started re-downloading stored web images...",
    failedToLoadInventoriesForCharacter = "Failed to load inventories for character",
    failedToGetTableInfo = "Failed to get table info",
    cannotRemoveLastColumnFromTable = "Cannot remove the last column from table",
    permitsPlayerTrades = "Permits direct player-to-player trades.",
