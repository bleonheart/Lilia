...
Reload: Drop]],
    ...
    assetDownloadWarning = "Warning: %d asset(s) failed to download. Check console for details.",
    assetDownloadWarningImages = "Warning: %d image(s) failed to download. Check console for details.",
    assetDownloadWarningSounds = "Warning: %d sound(s) failed to download. Check console for details.",
    assetDownloadWarningGeneral = "WARNING: Some assets failed to download. Check console output above for details.",
    ...
    logPlySpectate = "Admin '%s' started spectating player '%s'.",
    logStopSpectate = "Admin '%s' stopped spectating.",
    ...
    vendorWarningInvalidItem = "[Vendor] Warning: Cannot set stock for non-existent item '%s'",
    ...
    -- User-facing strings from localization report
    ...
    advancedWarningLogger = "AdvancedWarningLogger",
    advancedWarningRemovalLogger = "AdvancedWarningRemovalLogger",
    bunnyHop = "Bunny Hop",
    ...
    chessClientWager = "Chess ClientWager",
    chessTop10 = "Chess Top10",
    clickerAddToPoints = "ClickerAddToPoints",
    clientToServerOpenEditor = "Client_To_Server_OpenEditor",
    ...
    cubeRiotCaptureZoneUpdate = "CubeRiot CaptureZone Update",
    d3aCreateOrg = "D3A_CreateOrg",
    dragonBotAimKeySave = "DragonBot_AimKeySave",
    dListView = "DListView"
}