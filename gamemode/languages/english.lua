...
LANGUAGE = {
    ...
    flagManageRoster = "Gives access to manage faction rosters.",
    flagPhysgun = "Gives Access to Physgun.",
    flagToolgun = "Gives Access to Toolgun",
    rosterWrongFaction = "You can only view your own faction's roster.",
    rosterStaffDisabled = "This command cannot be used on a staff character.",
