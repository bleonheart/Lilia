...
LANGUAGE = {
    ...
    setAttributesSyntax = "[player Name] [string Attribute Name] [number Level]",
    checkAttributesSyntax = "[player Name]",
    addAttributesSyntax = "[player Name] [string Attribute Name] [number Level]",
