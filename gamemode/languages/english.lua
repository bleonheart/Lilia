...
LANGUAGE = {
    ...
    narratorDesc = "Sends an anonymous narration to players within a specified range (admin only).",
    narratorFormat = "* %s *",
    radioNarratorFormat = "* %s *",
...
Reload: Drop]],
    ...
    characterWipeConfirm = "TO CONFIRM CHARACTER DATA WIPE, RUN '%s' AGAIN in 3 SECONDS.",
    characterWipeProgress = "CHARACTER DATA WIPE IN PROGRESS.",
    doorWipeConfirm = "TO CONFIRM DOOR DATA WIPE, RUN '%s' AGAIN in 3 SECONDS.",
    doorWipeProgress = "DOOR DATA WIPE IN PROGRESS.",
    savedEntWipeConfirm = "TO CONFIRM SAVED ENTITIES WIPE, RUN '%s' AGAIN in 3 SECONDS.",
    savedEntWipeProgress = "SAVED ENTITIES WIPE IN PROGRESS.",
