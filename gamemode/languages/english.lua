...
LANGUAGE = {
    ...
    mustSuperAdminStopSound = "You need the 'Stop Sound For Everyone' privilege to run stopsound globally.",
    ...
    toggleCheaterPrivilege = "Toggle Cheater Status",
...
Reload: Drop]],
    ...
    consoleUsergroupNotFound = "[Lilia Administration] Error: usergroup not found.",
    consolePlayerNotFound = "[Lilia Administration] Error: specified player not found.",
    ...
    logSetSitroom = "Set the sitroom location",
    sitroomSetLog = "Sit room set at %s by '%s': %s. Position: %s",
    sitroomRenamedLog = "%s renamed a SitRoom: %s",
    sitroomRepositionedLog = "%s repositioned a SitRoom: %s",
    sitroomTeleportedLog = "Player '%s' teleported to SitRoom '%s'.",
    sitroomSentLog = "Player '%s' sent '%s' to SitRoom '%s'.",
    sitroomReturnSelfLog = "Player '%s' returned from a SitRoom.",
    sitroomReturnOtherLog = "Player '%s' returned '%s' from a SitRoom.",
    ...
    categorySpawnPermissions = "Spawn Permissions",
    categoryStaffPermissions = "Staff Permissions",
    categoryItems = "Items",
