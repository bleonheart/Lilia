...
LANGUAGE = {
    ...
    flagManageFaction = "Gives Access to managing your faction team.",
    ...
    staffTicketsCount = "Tickets Claimed",
    staffWarningsCount = "Warnings Issued",
    staffBansCount = "Bans Given",
    userGroup = "Usergroup",
    ticketsTab = "Tickets",
    ...
    viewAllClaimsDesc = "Displays a summary table of claim data for all administrators.",
    viewClaimsDesc = "Prints detailed claim information for every administrator to chat.",
    ...
    adminClaimsTitle = "Administrator Claims",
    ticketMessageYou = "You",
    ticketMessageToAdmins = "to administrators:",
    steamID = "SteamID",
    ...
    rosterDesc = "View your faction's roster.",
    factionManagementDesc = "Open the faction management menu.",
    adminMenuTitle = "Administrator Menu",
    ...
    loocPrefix = "[LOOC]",
    adminChatPrefix = "[Administrator Chat]",
    oocPrefix = "[OOC]",
    helpPrefix = "[HELP]",
    errorPrefix = "[ERROR]",
    ...
    itemWidthESPLabel = "Width: %s",
    itemHeightESPLabel = "Height: %s",
