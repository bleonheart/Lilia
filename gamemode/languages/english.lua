...
Reload: Drop]],
    ...
    stringPlayerOrSteamID = "[string Player Or Steam ID]",
    playerNameDurationReason = "[player Name] [number Duration optional] [string Reason]",
    playerNameReason = "[player Name] [string Reason optional]",
    stringSteamID = "[string SteamID]",
    playerNameDuration = "[player Name] [number Duration optional]",
    playerNameTime = "[player Name] [number Time optional]",
    playerNameTimeColorFade = "[player Name] [number Time optional] [string Color optional] [number FadeIn optional] [number FadeOut optional]",
    timeColorFade = "[number Time optional] [string Color optional] [number FadeIn optional] [number FadeOut optional]",
    playerNameOptional = "[player Name optional]",
    numberCharID = "[number Char ID]",
    stringSound = "[string Sound]",
    playerNameSound = "[player Name] [string Sound]",
    stringDescOptional = "[string Desc optional]",
    timeOptional = "[number Time optional]",
    playerNameFlags = "[player Name] [string Flags]",
    stringName = "[string Name]",
    stringNameOrNumberID = "[string Name or Number ID]",
    playerNameSpeed = "[player Name] [number Speed optional]",
    playerNameModel = "[player Name] [string Model optional]",
    playerNameItem = "[player Name] [item Item Name]",
    playerNameDescription = "[player Name] [string Description optional]",
    playerNameNewName = "[player Name] [string New Name optional]",
    playerNameScale = "[player Name] [number Scale optional]",
    playerNamePower = "[player Name] [number Power optional]",
    playerNameBodyGroupValue = "[player Name] [string BodyGroup Name] [number Value]",
    playerNameSkin = "[player Name] [number Skin]",
    playerNameAmount = "[player Name] [number Amount]",
    stringMessage = "[string Message]",
    stringBotNameMessage = "[string Bot Name] [string Message]",
    playerNameMessage = "[player Name] [string Message]",
    stringPasswordOptional = "[string Password optional]",
    numberAmount = "[number Amount]",
    playerTarget = "[player Target]",
    stringReason = "[string Reason]",
    playerTargetReason = "[player Target] [string Reason]",
    playerNameAttributeLevel = "[player Name] [string Attribute Name] [number Level]",
    stringAttributeName = "[string Attribute Name]",
    stringAction = "[string Action]",
    stringText = "[string Text]",
    numberPrice = "[number Price]",
    stringTitle = "[string Title]",
    factionFaction = "[faction Faction]",
    classClass = "[class Class]",
    playerNameWidthHeight = "[player Name] [number Width] [number Height]",
    stringRangeOptional = "[string Range optional] [string Name optional]",
    factionFactionSpawn = "[faction Faction]",
    numberRadiusOptional = "[number Radius optional]",
    playerNameFaction = "[player Name] [faction Faction]",
    playerNameClass = "[player Name] [class Class]",
