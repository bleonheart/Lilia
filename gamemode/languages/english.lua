...
LANGUAGE = {
    ...
    themesDisabledByServer = "Theme selection has been disabled by the server.",
    themes = "Themes",
    themeDark = "Dark",
...
Reload: Drop]],
    ...
    forceThemeDesc = "Forces all players to use the same theme, preventing theme changes.",
    theme = "Theme",
