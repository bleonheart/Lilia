...
function MODULE:LoadCharInformation()
    ...
    hook.Run("AddSection", L("adminStickSubCategoryAttributes"), Color(0, 0, 0), 2, 1)
    local attrs = {}
    ...
    for _, entry in ipairs(attrs) do
        ...
        hook.Run("AddBarField", L("adminStickSubCategoryAttributes"), id, attr.name, function() return minVal end, function() return maxVal end, function() return char:getAttrib(id) end)
    end
