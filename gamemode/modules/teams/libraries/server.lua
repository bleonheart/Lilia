...
net.Receive("liaRequestFactionMembers", function(_, client)
    lia.debug("[perm]", "Permission Check for net.Receive liaRequestFactionMembers", "hasPrivilege(listCharacters)=", tostring(client:hasPrivilege("listCharacters")), "finalResult=", tostring(client:hasPrivilege("listCharacters")))
...
net.Receive("liaKickCharacterToBase", function(_, client)
    lia.debug("[perm]", "Permission Check for net.Receive liaKickCharacterToBase", "hasPrivilege(canManageFactions)=", tostring(client:hasPrivilege("canManageFactions")), "finalResult=", tostring(client:hasPrivilege("canManageFactions")))
